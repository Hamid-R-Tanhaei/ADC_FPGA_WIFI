...
xst -ifn xst.scr
move DCM_AD_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\DCM_AD_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc DCM_AD_exdes.ucf DCM_AD_exdes

echo 'Running map'
map -timing -pr b DCM_AD_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm DCM_AD_exdes -w routed.ncd routed.vhd
cd ..
