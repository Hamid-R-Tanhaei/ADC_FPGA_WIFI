...
xst -ifn xst.scr
move ADSPI_DCM_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\ADSPI_DCM_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc ADSPI_DCM_exdes.ucf ADSPI_DCM_exdes

echo 'Running map'
map -timing -pr b ADSPI_DCM_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm ADSPI_DCM_exdes -w routed.ncd routed.vhd
cd ..
